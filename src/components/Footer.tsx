      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            {/* ✅ FIX : vrais liens réseaux sociaux */}
            <div className="flex gap-4 mt-2">
              <a href="https://www.instagram.com/fenuasim/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-fenua-orange transition-colors">
                <Instagram size={22} />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61574810369620" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-fenua-orange transition-colors">
                <Facebook size={22} />
              </a>
              <a href="#" aria-label="LinkedIn" className="hover:text-fenua-orange transition-colors">
                <Linkedin size={22} />
              </a>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href="https://www.trustpilot.com/review/fenuasim.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 group">
              <Image src="/images/trustpilot.svg" alt="Trustpilot" width={80} height={32} className="h-8 w-auto drop-shadow-lg group-hover:scale-110 transition-transform" />
