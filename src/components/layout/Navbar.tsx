      ...
      >
        ...
        >
          ...
          <ul className="hidden md:flex items-center gap-5 flex-1 justify-center">
            <li>
              <Link href="/shop" style={navLink(pathname.startsWith('/shop'))}>
                Nos eSIM
              </Link>
            </li>
            <li>
              <Link href="/assurance" style={navLink(pathname === '/assurance')}>
                Assurance
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/blog" style={navLink(pathname === '/blog')}>
                Blog
              </Link>
            </li>
            <li>
              <Link href="/faq" style={navLink(pathname === '/faq')}>
                FAQ
              </Link>
            </li>
          </ul>
              ...
              <div style={{ position: 'relative' }}>
                <button
                  ...
                  style={{
                    ...
                    gap: '6px',
                    background:
                      'linear-gradient(90deg,rgba(160,32,240,.08),rgba(255,127,17,.08))',
