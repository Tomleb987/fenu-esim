          ...
          <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
            ...
            <div style="background:white;padding:32px;border-radius:0 0 12px 12px;border:1px solid #eee;">
              ...
              <div style="text-align:center;margin:24px 0;">
                <a href="${devis.paymentUrl}" style="display:inline-block;background:linear-gradient(135deg,#A020F0,#FF7F11);color:white;padding:14px 32px;border-radius:12px;text-decoration:none;font-weight:bold;font-size:15px;">
                  💳 Payer maintenant
                </a>
                <p style="margin:8px 0 0;font-size:12px;color:#999;">Lien sécurisé Stripe · Valable 24h</p>
              </div>
