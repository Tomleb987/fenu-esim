  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background pb-20 font-sans text-foreground">
        ...
        <div className="text-center mt-16 text-muted-foreground text-sm space-y-1 pb-8">
            <p>🔒 Paiement sécurisé via Stripe · Support client 7j/7</p>
            <p>Assurance distribuée par FENUASIM — N° RUIA PF 26 012 · Contrat AVA Assurances — ORIAS 07 023 453</p>
            <p className="text-xs text-muted-foreground/70">
              ANSET ASSURANCES · 5 avenue du Prince Hinoi, 98713 Papeete · N° RUIA PF 26 010
            </p>
        </div>
      </div>
    </>
