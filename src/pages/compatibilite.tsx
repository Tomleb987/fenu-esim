...
--------------------------------------------------*/
const SUPPORT_EMAIL = "sav@fenuasim.com";
const EMAIL_SUBJECT = "Assistance : Vérification compatibilité eSIM";
const EMAIL_BODY = `Bonjour l'équipe Fenuasim,

Je souhaite vérifier si mon téléphone est compatible eSIM.
Voici mon modèle : [Indiquez votre modèle ici]

(Idéalement, joignez une capture d'écran du résultat *#06# ou de vos réglages)`;
    ...
    <div className="max-w-4xl mx-auto py-16 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Attention : certains modèles achetés à l'étranger ou bloqués par un opérateur ne fonctionnent pas avec l'eSIM.
          <span className="block mt-2 font-semibold text-purple-700">Voici comment vérifier en 30 secondes :</span>
        </p>
      </div>

      {/* --- MÉTHODE 1 : LE CODE UNIVERSEL (Héros) --- */}
      <div className="bg-white rounded-2xl shadow-lg border border-purple-100 overflow-hidden mb-12 relative">
        ...
        <div className="bg-purple-600 px-6 py-4 text-white flex items-center justify-center gap-2">
          ...
          <h2 className="text-xl font-bold">Méthode la plus fiable : le code magique</h2>
        </div>
        ...
        <div className="p-8 md:flex items-center gap-8">
          ...
          <div className="flex-1 space-y-4 mt-6 md:mt-0">
            <h3 className="text-lg font-bold text-gray-800 border-b pb-2">Comment lire le résultat ?</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3 bg-green-50 p-3 rounded-lg border border-green-200">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0" />
                <div className="text-sm text-green-900">
                  <span className="font-bold block">Compatible ✅</span>
                  Cherchez une ligne contenant <strong>"EID"</strong> (un numéro très long). Si vous l'avez, c'est bon !
                </div>
              </li>
              <li className="flex items-start gap-3 bg-red-50 p-3 rounded-lg border border-red-200">
                ...
                <div className="text-sm text-red-900">
                  ...
                  Si vous ne voyez que des lignes IMEI ou MEID sans aucun EID.
                </div>
              </li>
            </ul>
          </div>
          ...
          {activeTab === "ios" ? (
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className="bg-gray-100 p-2 rounded-lg font-mono text-sm text-gray-600">1</div>
                <div>
                   <p className="font-semibold">Allez dans Réglages {'>'} Données cellulaires</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-gray-100 p-2 rounded-lg font-mono text-sm text-gray-600">2</div>
                <div>
                   <p className="font-semibold">Cherchez le bouton bleu</p>
                   <p className="text-gray-600">Si vous voyez <strong>"Ajouter une eSIM"</strong> ou "Ajouter un forfait cellulaire", votre iPhone est prêt.</p>
                </div>
              </div>
            </div>
          ) : (
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                   ...
                   <p className="text-sm text-gray-500">(Le chemin peut varier selon la marque : cherchez "SIM" dans la barre de recherche)</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-gray-100 p-2 rounded-lg font-mono text-sm text-gray-600">2</div>
                <div>
                   <p className="font-semibold">Vérifiez l'option d'ajout</p>
                   <p className="text-gray-600">Si vous pouvez cliquer sur <strong>"Ajouter un forfait mobile"</strong> ou <strong>"Télécharger une SIM"</strong>, c'est compatible.</p>
                </div>
              </div>
            </div>
          )}
      ...
      <div className="bg-gray-900 rounded-3xl p-8 md:p-10 text-center text-white relative overflow-hidden shadow-2xl">
        ...
        <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-64 h-64 bg-orange-500 rounded-full opacity-20 blur-3xl"></div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-gray-300 mb-8 text-lg">
            Envoyez une capture d'écran de votre écran <strong>*#06#</strong> à notre équipe technique. Nous vous répondrons rapidement.
          </p>

          <a 
            href={`mailto:${SUPPORT_EMAIL}?subject=${encodeURIComponent(EMAIL_SUBJECT)}&body=${encodeURIComponent(EMAIL_BODY)}`}
          ...
          >
            ...
            Envoyer ma demande à {SUPPORT_EMAIL}
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </a>
          
          <p className="mt-6 text-sm text-gray-500">
            Ou écrivez-nous directement depuis votre boîte mail habituelle.
          </p>
        </div>
      </div>
