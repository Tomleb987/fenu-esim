...
const PARTNERS = [
  ...
  },
  {
    ...
    icon: <Plane size={17} />,
    description:
      "Go Frenchies accompagne les francophones dans leur projet de départ, d’installation ou de voyage à l’étranger. FENUA SIM permet de rester connecté dès l’arrivée.",
    tags: ["Francophones", "Voyage", "Expatriation"],
    ...
    <main style={{ minHeight: "100vh", background: "#F8FAFC" }}>
      ...
      >
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            Rejoignez le réseau FENUA SIM et proposez une solution eSIM simple,
            rapide et utile à vos clients partout dans le monde.
          </p>
      ...
      <section id="partenaires" style={{ maxWidth: 1180, margin: "0 auto", padding: "72px 24px" }}>
        ...
        >
          {PARTNERS.map((p) => (
            ...
            >
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 5, background: p.color }} />
