...
const REGION_TRANSLATIONS: Record<string, string> = {
  ...
  "Japan": "Japon", "Canary Islands": "Iles Canaries", "South Korea": "Coree du Sud",
  ...
  "India": "Inde", "China": "Chine", "Taiwan": "Taiwan",
  "United Kingdom": "Royaume-Uni", "Germany": "Allemagne", "Spain": "Espagne",
  "Italy": "Italie", "Greece": "Grece", "Portugal": "Portugal",
  "Netherlands": "Pays-Bas", "Belgium": "Belgique", "Switzerland": "Suisse",
  "Austria": "Autriche", "Poland": "Pologne", "Czech Republic": "Republique tcheque",
  "Turkey": "Turquie", "Egypt": "Egypte", "Morocco": "Maroc",
  "South Africa": "Afrique du Sud", "Brazil": "Bresil", "Argentina": "Argentine",
  "Chile": "Chili", "Colombia": "Colombie", "Peru": "Perou",
  ...
  "Albania": "Albanie", "Algeria": "Algerie", "Armenia": "Armenie",
  "Bangladesh": "Bangladesh", "Bulgaria": "Bulgarie", "Cambodia": "Cambodge",
  "Croatia": "Croatie", "Cyprus": "Chypre", "Denmark": "Danemark",
  "Ecuador": "Equateur", "Estonia": "Estonie", "Ethiopia": "Ethiopie",
  "Finland": "Finlande", "Georgia": "Georgie", "Ghana": "Ghana",
  ...
  "Mauritius": "Maurice", "Mongolia": "Mongolie", "Montenegro": "Montenegro",
  "Myanmar": "Myanmar", "Namibia": "Namibie", "Nepal": "Nepal",
  "Nigeria": "Nigeria", "Norway": "Norvege", "Pakistan": "Pakistan",
  "Panama": "Panama", "Romania": "Roumanie", "Russia": "Russie",
  "Rwanda": "Rwanda", "Senegal": "Senegal", "Serbia": "Serbie",
  "Slovakia": "Slovaquie", "Slovenia": "Slovenie", "Sri Lanka": "Sri Lanka",
  "Sweden": "Suede", "Tanzania": "Tanzanie", "Tunisia": "Tunisie",
...
const TOP_DESTINATIONS = ["France", "Canada", "Etats-Unis", "Australie", "Nouvelle-Zelande", "Japon", "Europe"];
...
export default function PartnerDashboard() {
  ...
  const loadPackages = async () => {
    ...
    while (true) {
      const { data, error } = await supabase
        ...
        .select("id, name, data_amount, data_unit, validity_days, validity, price_xpf, final_price_xpf, price_eur, final_price_eur, currency, status, country, region, region_fr, operator_name, flag_url, type, includes_voice, includes_sms")
        .eq("status", "active")
  ...
  const sendViaWhatsApp = () => {
    const msg = "Bonjour " + clientForm.firstName + ", voici votre lien de paiement securise pour votre eSIM FenuaSIM :\n" + generatedLink;
